_base_ = [
    ...
    '../_base_/models/centerpoint_pp_01voxel_second_secfpn_zc.py',
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        task_weight=[2.0,2.5,1.0,1.0,1.0],
        # remove vel
        common_heads=dict(
...
db_sampler = dict(
    ...
    filter_by_min_points=dict(Car=20, Pedestrian=20, Cyclist=20, Truck=20, Train=20)),
    classes=class_names,
    sample_groups=dict(Car=3, Pedestrian=2, Cyclist=5, Truck=5, Train=5),
    points_loader=dict(
